  ...
  return (
    <Card className="flex flex-col h-full">
      ...
      <div className="flex-grow mt-4">
        ...
        <p className="text-gray-600 text-sm mt-1 line-clamp-3" dangerouslySetInnerHTML={{ __html: work.description }} />
      ...
      {showActions && (
        <div className="mt-4 pt-4 border-t border-gray-100 flex gap-2 justify-end">
          <Button variant="ghost" size="sm" onClick={() => onViewReflection && onViewReflection(work._id)} title="View/Add Reflection">
            <Eye size={18} />
          </Button>
